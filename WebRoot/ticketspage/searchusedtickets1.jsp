...
.ys_1 {	font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif;
}
.ys_1 {	font-family: "Arial Unicode MS";
}
.ys_1 {	font-family: Verdana, Geneva, sans-serif;
	color: #09F;
	text-align: center;
	font-size: 16px;
	font-weight: bold;
...
<table width="959" border="0">
  <tr>
    <td width="343" height="87">&nbsp;<img  src="src/logo4.png" width="453" height="113" align="absbottom" onclick="MM_goToURL('parent','index.jsp');return document.MM_returnValue" /></td>
...
<form action="searchticketsbydescription.action" method="post">
<font color = "black" >
			...
			<tr>
				...
				<tr>
               	<td width="863" align="center">
                    <input name="description" type="text" size="15" style="font-size:20px"/></td>
				...
				<tr width="863" align="center" >
					<td>
						请输入关键字<input type="submit" value="搜索"style="font-size:20px">
					</td>
