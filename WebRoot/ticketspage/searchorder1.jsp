...
<table width="953" height="404" border="0" align="left" cellpadding="0" cellspacing="5">
  <tr>
    <td width="863" height="350">
    <div id="apDiv1"><center>
...
<font color = "black" >
			<table>
				<tr>
                  ...
                  请输入用户名<input name="username" type="text" size="15" style="font-size:20px"/></td>
